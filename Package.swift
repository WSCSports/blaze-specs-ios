...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "BlazeSDK",
                      url: "https://github.com/WSCSports/blaze-specs-ios/releases/download/1.1.0/BlazeSDK.zip",
                      checksum: "8c25079759482963c6f236b952f01499d1426b8e2a5b7f22f64b3d6ecdff1959"),
