...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "BlazeSDK",
                      url: "https://github.com/WSCSports/blaze-specs-ios/releases/download/1.0.4/BlazeSDK.zip",
                      checksum: "77b96d0760daf6308c00db4dd67953789437ba8838b29a858759f6dbb789cb53"),
