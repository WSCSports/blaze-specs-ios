...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "BlazeSDK",
                      url: "https://github.com/WSCSports/blaze-specs-ios/releases/download/1.4.1/BlazeSDK.zip",
                      checksum: "eec6eaa2c999949fbf3d5df6bfdc6e584b86d9dce566579c4824fd06152555cd"),
