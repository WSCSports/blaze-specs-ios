...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "BlazeSDK",
                      url: "https://github.com/WSCSports/blaze-specs-ios/releases/download/1.16.3/BlazeSDK.zip",
                      checksum: "e440d8888a7f694f0183a5ef812ccc7c9bcee95fb73a25d12959ec985a3d64d6"),
