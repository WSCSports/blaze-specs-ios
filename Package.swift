...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "BlazeSDK",
                      url: "https://github.com/WSCSports/blaze-specs-ios/releases/download/1.17.2/BlazeSDK.zip",
                      checksum: "9d3f97887162a71f68d11b38ea0f15e07037761618eccf4300c44f7e7bfa4cda"),
